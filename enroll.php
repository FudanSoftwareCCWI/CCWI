...
<link rel="stylesheet" type="text/css" href="<?php echo $wwwRoot?>/css/jquery-ui.css">
<script type="text/javascript" src="<?php echo $wwwRoot?>/js/jquery-1.10.2.min.js"></script>
<script type="text/javascript" src="<?php echo $wwwRoot?>/js/jquery-ui.js"></script>
<script type="text/javascript" src="<?php echo $wwwRoot?>/js/enroll.js"></script>
</head>
<body>
	<div class="wrapper">
			...
			<div class="header_content">
				<div id="nav_menu" class="header_l_nav">
					...
					<ul class="menu_content">
						...
						<li><a class="text" href="<?php echo $wwwRoot?>/public/">近期活动</a></li>

...
<script type="text/javascript" src="<?php echo $wwwRoot?>/js/team.js"></script>
			...
			<div class="header_content">
				<div id="nav_menu" class="header_l_nav">
					...
					<ul class="menu_content">
						...
						<li><a class="text hltxt" href="<?php echo $wwwRoot?>/team/">奉献爱心</a></li>
				...
				<div class="block">
					<div class="item">
						<div class="item_content" id="side_left">
							<div class="sidebar-row1" id="1-0">
								<div class="sidebar-title nrbg">关于我们</div>
					...
					<div class="item-col2">
						<div class='item_content showpart' id='content-1-0'>
							...
							<a href="https://me.alipay.com/ccwi" target="_blank" class="hltxt x-large">马上捐款</a>
						</div>
